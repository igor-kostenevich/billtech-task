...
<template>
  <aside class="bg-white rounded-[5px] pt-5 pb-2.5 w-full md:max-w-[232px] shadow-lg">
    ...
    <div class="flex md:flex-col flex-wrap">
      <BaseCheckbox
        ...
        :label="opt.label"
        class="px-2 md:px-5 py-2.5 cursor-pointer hover:bg-light-secondary transition-colors"
